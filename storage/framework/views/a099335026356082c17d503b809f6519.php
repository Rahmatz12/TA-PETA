...
<div class="map-page">
    ...
    <div class="sidebar">
        ...
        <div class="filter-chips">
            ...
            <div class="chip primer" onclick="filterChips('primer', this)">Primer (<?php echo e($salurans->where('jenis', 'primer')->count()); ?>)</div>
            <div class="chip sekunder" onclick="filterChips('sekunder', this)">Sekunder (<?php echo e($salurans->where('jenis', 'sekunder')->count()); ?>)</div>
            <div class="chip tersier" onclick="filterChips('tersier', this)">Tersier (<?php echo e($salurans->where('jenis', 'tersier')->count()); ?>)</div>
            <div class="chip pintu" onclick="filterChips('pintu', this)">Pintu (<?php echo e($salurans->where('jenis', 'pintu')->count()); ?>)</div>
            <div class="chip bendungan" onclick="filterChips('bendungan', this)">Bendungan (<?php echo e($salurans->where('jenis', 'bendungan')->count()); ?>)</div>
        </div>
        <div class="sidebar-stats">
            <div class="s-stat"><h4 style="color:var(--primary)"><?php echo e($total); ?></h4><p>Total</p></div>
            <div class="s-stat"><h4 style="color:#0B2B26"><?php echo e($aktif); ?></h4><p>Aktif</p></div>
            <div class="s-stat"><h4 style="color:#235347"><?php echo e($total - $aktif); ?></h4><p>Nonaktif</p></div>
        </div>
        <div class="sidebar-list" id="sidebarList">
            <?php $__currentLoopData = $salurans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $saluran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="list-item" id="list-item-<?php echo e($saluran->id); ?>" onclick="focusSaluran(<?php echo e($saluran->id); ?>)">
                <div class="list-icon" style="background: <?php echo e(match($saluran->jenis) { 'primer' => '#DAF1DE', 'sekunder' => '#c5e8ce', 'tersier' => '#b8dfc4', 'pintu' => '#a8d5b5', 'bendungan' => '#DAF1DE', default => '#e2e8f0' }); ?>; color: <?php echo e(match($saluran->jenis) { 'primer' => '#051F20', 'sekunder' => '#0B2B26', 'tersier' => '#163832', 'pintu' => '#0B2B26', 'bendungan' => '#235347', default => '#64748b' }); ?>;">
                    <i class="fas <?php echo e(match($saluran->jenis) { 'primer' => 'fa-water', 'sekunder' => 'fa-stream', 'tersier' => 'fa-project-diagram', 'pintu' => 'fa-dungeon', 'bendungan' => 'fa-dam', default => 'fa-map-marker' }); ?>"></i>
                </div>
                <div class="list-info">
                    <h4><?php echo e($saluran->nama); ?></h4>
                    <p><?php echo e($saluran->kecamatan); ?></p>
                    <div class="list-badges">
                        <span class="lb" style="background: <?php echo e(match($saluran->jenis) { 'primer' => '#DAF1DE', 'sekunder' => '#c5e8ce', 'tersier' => '#b8dfc4', 'pintu' => '#a8d5b5', 'bendungan' => '#DAF1DE', default => '#e2e8f0' }); ?>; color: <?php echo e(match($saluran->jenis) { 'primer' => '#051F20', 'sekunder' => '#0B2B26', 'tersier' => '#163832', 'pintu' => '#0B2B26', 'bendungan' => '#235347', default => '#64748b' }); ?>"><?php echo e(ucfirst($saluran->jenis)); ?></span>
                        <span class="lb" style="background: <?php echo e($saluran->kondisi == 'baik' ? '#DAF1DE' : ($saluran->kondisi == 'perbaikan' ? '#fef3c7' : '#fee2e2')); ?>; color: <?php echo e($saluran->kondisi == 'baik' ? '#0B2B26' : ($saluran->kondisi == 'perbaikan' ? '#92400e' : '#b91c1c')); ?>"><?php echo e(ucfirst(str_replace('-', ' ', $saluran->kondisi))); ?></span>
                    </div>
                </div>
            </div>
    ...
    <div class="detail-card" id="detailCard">
        ...
        <div class="card-body">
            ...
            <div class="btn-group">
                ...
                <a href="<?php echo e(route('laporan.create')); ?>" class="btn btn-secondary-light"><i class="fas fa-exclamation-triangle"></i> Lapor</a>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rahmat Eka\Peta-Interaktif\resources\views/masyarakat/peta.blade.php ENDPATH**/ ?>