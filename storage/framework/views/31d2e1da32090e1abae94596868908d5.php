<?php $__env->startSection('title', 'Laporan Kerusakan - SIG Irigasi Sidoarjo'); ?>
...
<div class="main-container">
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <div class="stat-info"><h3><?php echo e($stats['total']); ?></h3><p>Total Laporan</p></div>
        </div>
        <div class="stat-card">
            <div class="stat-icon si-tunggu"><i class="fas fa-clock"></i></div>
            <div class="stat-info"><h3><?php echo e($stats['menunggu']); ?></h3><p>Menunggu</p></div>
        </div>
        <div class="stat-card">
            <div class="stat-icon si-proses"><i class="fas fa-tools"></i></div>
            <div class="stat-info"><h3><?php echo e($stats['diproses']); ?></h3><p>Diproses</p></div>
        </div>
        <div class="stat-card">
            <div class="stat-icon si-selesai"><i class="fas fa-check-circle"></i></div>
            <div class="stat-info"><h3><?php echo e($stats['selesai']); ?></h3><p>Selesai</p></div>
        </div>
    </div>
    ...
    <div class="search-card">
        <div class="search-card-header">
            ...
            <a href="<?php echo e(route('laporan.create')); ?>" class="btn-outline-green"><i class="fas fa-plus"></i> Buat Laporan Baru</a>
        </div>
        <form method="GET" action="<?php echo e(route('laporan.index')); ?>" class="search-grid">
            <div>
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="kode" placeholder="Contoh: 2026-00001" value="<?php echo e(request('kode')); ?>" autocomplete="off">
            ...
            <div>
                ...
                <div class="input-group">
                    ...
                    <input type="tel" name="telepon" placeholder="81234567890" value="<?php echo e(request('telepon')); ?>">
                    <button type="submit" class="btn-search"><i class="fas fa-search"></i> Cari</button>
                </div>
            </div>
        </form>
    ...
    <div class="filter-bar">
        <span>Filter:</span>
        <a href="<?php echo e(route('laporan.index')); ?>" class="filter-pill <?php echo e(!request('status') || request('status')=='all' ? 'active' : ''); ?>">Semua</a>
        <a href="<?php echo e(route('laporan.index')); ?>?status=menunggu" class="filter-pill <?php echo e(request('status')=='menunggu' ? 'active' : ''); ?>"><span style="width:8px;height:8px;border-radius:50%;background:#eab308"></span> Menunggu</a>
        <a href="<?php echo e(route('laporan.index')); ?>?status=diverifikasi" class="filter-pill <?php echo e(request('status')=='diverifikasi' ? 'active' : ''); ?>"><span style="width:8px;height:8px;border-radius:50%;background:#22c55e"></span> Diverifikasi</a>
        <a href="<?php echo e(route('laporan.index')); ?>?status=diproses" class="filter-pill <?php echo e(request('status')=='diproses' ? 'active' : ''); ?>"><span style="width:8px;height:8px;border-radius:50%;background:#a855f7"></span> Diproses</a>
        <a href="<?php echo e(route('laporan.index')); ?>?status=selesai" class="filter-pill <?php echo e(request('status')=='selesai' ? 'active' : ''); ?>"><span style="width:8px;height:8px;border-radius:50%;background:#3b82f6"></span> Selesai</a>
        <a href="<?php echo e(route('laporan.index')); ?>?status=ditolak" class="filter-pill <?php echo e(request('status')=='ditolak' ? 'active' : ''); ?>"><span style="width:8px;height:8px;border-radius:50%;background:#ef4444"></span> Ditolak</a>
    </div>
    ...
    <div class="report-card">
        <div>
            <div class="report-top">
                ...
                ?>
                <span class="sbadge <?php echo e($sClass); ?>"><span style="width:7px;height:7px;border-radius:50%;background:currentColor"></span> <?php echo e($sText); ?></span>
                <span class="pbadge <?php echo e($pClass); ?>"><?php echo e(ucfirst($laporan->tingkat_keparahan)); ?></span>
            </div>
            <div class="report-title"><?php echo e($laporan->jenis_kerusakan); ?></div>
            <div class="report-location"><i class="fas fa-map-marker-alt"></i> <?php echo e($laporan->nama_saluran); ?> - <?php echo e($laporan->kecamatan); ?></div>
            <div class="report-desc"><?php echo e(Str::limit($laporan->deskripsi_kerusakan, 120)); ?></div>
            <div class="report-meta">
                <span><i class="fas fa-user"></i> <?php echo e($laporan->is_anonymous ? 'Anonim' : $laporan->nama_pelapor); ?></span>
                <span><i class="fas fa-calendar"></i> <?php echo e($laporan->created_at->format('d M Y')); ?></span>
                <span><i class="fas fa-phone"></i> <?php echo e($laporan->telepon); ?></span>
            </div>
        </div>
        <div style="text-align:right">
            <div class="report-code-wrap">
                <div class="report-code-label">Kode Laporan</div>
                <div class="report-code-value"><?php echo e($laporan->kode_laporan); ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="empty-state">
        ...
        <a href="<?php echo e(route('laporan.create')); ?>" class="btn-primary" style="display:inline-flex;margin:0 auto"><i class="fas fa-plus"></i> Buat Laporan Pertama</a>
    </div>
    <?php endif; ?>

    <div style="margin-top:1rem"><?php echo e($laporans->links()); ?></div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rahmat Eka\Peta-Interaktif\resources\views/masyarakat/laporan.blade.php ENDPATH**/ ?>