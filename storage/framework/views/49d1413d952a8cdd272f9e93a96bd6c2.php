...
<body>
    <div class="admin-auth-wrapper">
        ...
        <div class="admin-form">
            <a href="<?php echo e(route('home')); ?>" class="back-link"><i class="fas fa-arrow-left"></i> Kembali ke beranda</a>
            ...
            <?php if(session('success')): ?>
                <div class="flash-message flash-success"><?php echo e(session('success')); ?></div>
            <?php endif; ?>
            <?php if(session('error')): ?>
                <div class="flash-message flash-error"><?php echo e(session('error')); ?></div>
            <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>" placeholder="admin@sigirigasi.id" value="<?php echo e(old('email')); ?>" required>
...
<?php /**PATH C:\Users\Rahmat Eka\Peta-Interaktif\resources\views/auth/admin-login.blade.php ENDPATH**/ ?>