<?php $__env->startSection('title', 'Kelola Pengguna - SIG Irigasi Sidoarjo'); ?>
...
<div class="tab-bar">
    <button class="tab-btn <?php echo e($tab == 'masyarakat' ? 'active' : ''); ?>" onclick="switchTab('masyarakat')">Masyarakat</button>
    <button class="tab-btn <?php echo e($tab == 'admin' ? 'active' : ''); ?>" onclick="switchTab('admin')">Admin & Petugas</button>
</div>

<!-- Tab Masyarakat -->
<div id="tab-masyarakat" class="tab-content <?php echo e($tab == 'masyarakat' ? 'active' : ''); ?>">
    <div class="card-white">
        ...
        <div style="padding:1.25rem 1.5rem">
            <form method="GET" action="<?php echo e(route('admin.users.index')); ?>" class="search-bar">
                ...
                <input type="text" name="search" class="search-input" placeholder="Cari nama atau email..." value="<?php echo e($search); ?>">
            ...
            <table class="data-table">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $masyarakats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td>
                            <div style="display:flex;align-items:center;gap:0.6rem">
                                <div class="avatar-sm" style="background:#e0f2fe;color:#0369a1"><?php echo e(substr($u->name, 0, 1)); ?></div>
                        ...
                        <td>
                            <form method="POST" action="<?php echo e(route('admin.users.masyarakat.destroy', $u->id)); ?>" style="display:inline" onsubmit="return confirm('Yakin ingin menghapus pengguna ini?')">
            ...
            <div style="padding:1rem 1.5rem;border-top:1px solid #f1f5f9"><?php echo e($masyarakats->links()); ?></div>
        </div>
    </div>
</div>

<!-- Tab Admin -->
<div id="tab-admin" class="tab-content <?php echo e($tab == 'admin' ? 'active' : ''); ?>">
    <div class="card-white">
        ...
        <div style="padding:1.25rem 1.5rem">
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div style="display:flex;align-items:center;gap:0.6rem">
                                <div class="avatar-sm" style="background:#ede9fe;color:#7c3aed"><?php echo e(substr($a->name, 0, 1)); ?></div>
                                <span style="font-weight:600"><?php echo e($a->name); ?></span>
                            </div>
                        </td>
                        <td><?php echo e($a->email); ?></td>
                        <td><?php echo e($a->phone ?? '-'); ?></td>
                        <td><span class="role-badge role-<?php echo e($a->role); ?>"><i class="fas fa-<?php echo e($a->role=='admin'?'shield-alt':'user-cog'); ?>"></i> <?php echo e(ucfirst($a->role)); ?></span></td>
                        <td><span style="color:<?php echo e($a->status=='aktif'?'#16a34a':'#ef4444'); ?>;font-weight:600;font-size:0.82rem"><i class="fas fa-circle" style="font-size:0.5rem"></i> <?php echo e(ucfirst($a->status)); ?></span></td>
                        <td>
                            <form method="POST" action="<?php echo e(route('admin.users.admin.destroy', $a->id)); ?>" style="display:inline" onsubmit="return confirm('Yakin ingin menghapus admin/petugas ini?')">
                                <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                <button type="submit" class="btn-danger-sm"><i class="fas fa-trash-alt"></i> Hapus</button>
                            </form>
                        </td>
            ...
            <div style="padding:1rem 1.5rem;border-top:1px solid #f1f5f9"><?php echo e($admins->links()); ?></div>
        </div>
    </div>
</div>
...
<div class="modal-overlay" id="modalTambahAdmin">
    <div class="modal-box">
        ...
        <form method="POST" action="<?php echo e(route('admin.users.admin.store')); ?>">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rahmat Eka\Peta-Interaktif\resources\views/admin/manage-users.blade.php ENDPATH**/ ?>