<?php $__env->startSection('title', 'Beranda - SIG Irigasi Sidoarjo'); ?>
...
<section class="hero">
    <div class="hero-content">
        ...
        <div class="hero-buttons">
            ...
            <a href="<?php echo e(route('peta.index')); ?>" class="btn-outline"><i class="fas fa-map"></i> Buka Peta Interaktif</a>
        </div>
    </div>
</section>
...
<section class="stats-section">
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <h3><?php echo e($totalSaluran); ?></h3>
            <p>Total Saluran</p>
            <a href="<?php echo e(route('data-irigasi.index')); ?>" class="stat-link">Lihat semua &rarr;</a>
        </div>
        <div class="stat-card">
            <div class="stat-icon green"><i class="fas fa-check-circle"></i></div>
            <h3><?php echo e($saluranAktif); ?></h3>
            <p>Saluran Aktif</p>
            <a href="<?php echo e(route('data-irigasi.index')); ?>?kondisi=baik" class="stat-link">Filter aktif &rarr;</a>
        </div>
        <div class="stat-card">
            <div class="stat-icon orange"><i class="fas fa-exclamation-triangle"></i></div>
            <h3><?php echo e($saluranRusak); ?></h3>
            <p>Saluran Bermasalah</p>
            <a href="<?php echo e(route('data-irigasi.index')); ?>" class="stat-link">Filter rusak &rarr;</a>
        </div>
        <div class="stat-card">
            <div class="stat-icon purple"><i class="fas fa-layer-group"></i></div>
            <h3>5</h3>
            <p>Jenis Saluran</p>
            <a href="<?php echo e(route('peta.index')); ?>" class="stat-link">Lihat di peta &rarr;</a>
        </div>
    </div>
</section>
...
<section class="categories-section">
    <div class="section-header">
        ...
        <a href="<?php echo e(route('peta.index')); ?>" class="link-arrow">Lihat semua di peta <i class="fas fa-chevron-right"></i></a>
    </div>
    <div class="categories-grid">
        <div class="category-card" onclick="window.location='<?php echo e(route('data-irigasi.index')); ?>?jenis=primer'">
            <div class="category-icon red"><i class="fas fa-water"></i></div>
            <h4>Saluran Primer</h4>
            <p><?php echo e($categories['primer']); ?> saluran</p>
        </div>
        <div class="category-card" onclick="window.location='<?php echo e(route('data-irigasi.index')); ?>?jenis=sekunder'">
            <div class="category-icon green"><i class="fas fa-stream"></i></div>
            <h4>Saluran Sekunder</h4>
            <p><?php echo e($categories['sekunder']); ?> saluran</p>
        </div>
        <div class="category-card" onclick="window.location='<?php echo e(route('data-irigasi.index')); ?>?jenis=tersier'">
            <div class="category-icon blue"><i class="fas fa-project-diagram"></i></div>
            <h4>Saluran Tersier</h4>
            <p><?php echo e($categories['tersier']); ?> saluran</p>
        </div>
        <div class="category-card" onclick="window.location='<?php echo e(route('data-irigasi.index')); ?>?jenis=pintu'">
            <div class="category-icon orange"><i class="fas fa-dungeon"></i></div>
            <h4>Pintu Air</h4>
            <p><?php echo e($categories['pintu']); ?> unit</p>
        </div>
        <div class="category-card" onclick="window.location='<?php echo e(route('data-irigasi.index')); ?>?jenis=bendungan'">
            <div class="category-icon teal"><i class="fas fa-dam"></i></div>
            <h4>Bendungan</h4>
            <p><?php echo e($categories['bendungan']); ?> unit</p>
        </div>
    </div>
</section>
...
<section class="table-section" id="data-table">
    <div class="table-header">
        ...
        <div class="table-actions">
            <a href="<?php echo e(route('data-irigasi.index')); ?>" class="btn-secondary"><i class="fas fa-bars"></i> Kelola Data</a>
            <a href="<?php echo e(route('peta.index')); ?>" class="btn-primary"><i class="fas fa-map"></i> Buka Peta</a>
        </div>
    </div>
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                <?php $__currentLoopData = $salurans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $saluran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="no-cell"><?php echo e($salurans->firstItem() + $index); ?></td>
                    <td class="name-cell">
                        <h4><?php echo e($saluran->nama); ?></h4>
                        <p><?php echo e($saluran->alamat ?? '-'); ?></p>
                    </td>
                    <td><span class="badge-type <?php echo e($saluran->jenis); ?>"><?php echo e(ucfirst($saluran->jenis)); ?></span></td>
                    <td><?php echo e($saluran->kecamatan); ?></td>
                    <td>
                        <?php
                        ...
                        ?>
                        <span class="badge-status <?php echo e($statusClass); ?>"><?php echo e($statusText); ?></span>
                    </td>
                    <td><span class="badge-status aktif"><i class="fas fa-check"></i> Aktif</span></td>
                    <td>
                        <?php if($saluran->latitude && $saluran->longitude): ?>
                            <a href="<?php echo e(route('peta.index')); ?>?lat=<?php echo e($saluran->latitude); ?>&lng=<?php echo e($saluran->longitude); ?>" class="btn-peta"><i class="fas fa-map-marker-alt"></i> Peta</a>
                        <?php else: ?>
                            -
                        <?php endif; ?>
                    </td>
        ...
        <div class="pagination">
            <div class="pagination-info">Menampilkan <?php echo e($salurans->firstItem() ?? 0); ?>-<?php echo e($salurans->lastItem() ?? 0); ?> dari <?php echo e($salurans->total()); ?> saluran</div>
            <div><?php echo e($salurans->links()); ?></div>
        </div>

        <div class="table-footer">
            <div class="update-info">Data diperbarui secara real-time dari database</div>
            <a href="<?php echo e(route('data-irigasi.index')); ?>" class="manage-link">Lihat & kelola semua data &rarr;</a>
        </div>
    </div>
</section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rahmat Eka\Peta-Interaktif\resources\views/masyarakat/home.blade.php ENDPATH**/ ?>