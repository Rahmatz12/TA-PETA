...
@section('title', 'Form Laporan Kerusakan - SIG Irigasi Sidoarjo')
            ...
            <div class="form-card-body">
                <div class="form-row cols-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_saluran" class="form-control" placeholder="Contoh: Saluran Primer Krian" value="{{ old('nama_saluran') }}" required>
                    </div>
                    <div class="form-group">
                        ...
                        <select name="jenis_saluran" class="form-control" required>
                            ...
                            <option value="primer" {{ old('jenis_saluran')=='primer'?'selected':'' }}>Saluran Primer</option>
                            <option value="sekunder" {{ old('jenis_saluran')=='sekunder'?'selected':'' }}>Saluran Sekunder</option>
                            <option value="tersier" {{ old('jenis_saluran')=='tersier'?'selected':'' }}>Saluran Tersier</option>
                            <option value="pintu" {{ old('jenis_saluran')=='pintu'?'selected':'' }}>Pintu Air</option>
                            <option value="bendungan" {{ old('jenis_saluran')=='bendungan'?'selected':'' }}>Bendungan / Embung</option>
                        </select>
                    </div>
                </div>
                <div class="form-row cols-3">
                    <div class="form-group">
                        ...
                        <select name="kecamatan" class="form-control" required>
                            ...
                            @foreach(['Sidoarjo','Buduran','Candi','Porong','Krembung','Tulangan','Tanggulangin','Jabon','Krian','Balongbendo','Wonoayu','Tarik','Prambon','Taman','Gedangan','Sedati','Sukodono','Waru'] as $kec)
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="alamat" class="form-control" placeholder="Nama jalan" value="{{ old('alamat') }}">
                    </div>
                </div>
                <div class="form-group">
                    <label><i class="fas fa-align-left" style="margin-right:0.2rem;color:#94a3b8"></i> Deskripsi Lokasi</label>
                    <textarea name="deskripsi_lokasi" class="form-control" placeholder="Deskripsikan lokasi saluran secara detail" style="min-height:80px">{{ old('deskripsi_lokasi') }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                <div class="form-group" style="margin-bottom:1.25rem">
                    ...
                    <textarea name="jenis_kerusakan" class="form-control" placeholder="Deskripsikan jenis kerusakan yang Anda temukan" style="min-height:100px" required>{{ old('jenis_kerusakan') }}</textarea>
                </div>
                <div class="form-group" style="margin-bottom:1.25rem">
                    ...
                    <div class="severity-grid">
                        <div>
                            <input type="radio" name="tingkat_keparahan" id="sev-ringan" value="ringan" class="severity-option" {{ old('tingkat_keparahan')=='ringan'?'checked':'' }} required>
                        ...
                        <div>
                            <input type="radio" name="tingkat_keparahan" id="sev-sedang" value="sedang" class="severity-option" {{ old('tingkat_keparahan')=='sedang'?'checked':'' }}>
                        ...
                        <div>
                            <input type="radio" name="tingkat_keparahan" id="sev-berat" value="berat" class="severity-option" {{ old('tingkat_keparahan')=='berat'?'checked':'' }}>
                        ...
                        <div>
                            <input type="radio" name="tingkat_keparahan" id="sev-kritis" value="kritis" class="severity-option" {{ old('tingkat_keparahan')=='kritis'?'checked':'' }}>
                ...
                <div class="form-row cols-2">
                    <div class="form-group">
                        ...
                        <select name="dampak_pertanian" class="form-control">
                            ...
                            <option value="tidak-ada" {{ old('dampak_pertanian')=='tidak-ada'?'selected':'' }}>Tidak ada dampak langsung</option>
                            <option value="ringan" {{ old('dampak_pertanian')=='ringan'?'selected':'' }}>Dampak Ringan</option>
                            <option value="sedang" {{ old('dampak_pertanian')=='sedang'?'selected':'' }}>Dampak Sedang</option>
                            <option value="berat" {{ old('dampak_pertanian')=='berat'?'selected':'' }}>Dampak Berat</option>
                            <option value="sangat-berat" {{ old('dampak_pertanian')=='sangat-berat'?'selected':'' }}>Sangat Berat</option>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select name="lama_kerusakan" class="form-control">
                            ...
                            <option value="baru" {{ old('lama_kerusakan')=='baru'?'selected':'' }}>Baru terjadi</option>
                            <option value="1-7" {{ old('lama_kerusakan')=='1-7'?'selected':'' }}>1 - 7 hari lalu</option>
                            <option value="7-30" {{ old('lama_kerusakan')=='7-30'?'selected':'' }}>1 minggu - 1 bulan</option>
                            <option value="lebih-1" {{ old('lama_kerusakan')=='lebih-1'?'selected':'' }}>Lebih dari 1 bulan</option>
                            <option value="tidak-tahu" {{ old('lama_kerusakan')=='tidak-tahu'?'selected':'' }}>Tidak diketahui</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    <label><i class="fas fa-file-alt" style="margin-right:0.2rem;color:#94a3b8"></i> Dampak & Kondisi Terkini <span class="req">*</span></label>
                    <textarea name="deskripsi_kerusakan" class="form-control" placeholder="Jelaskan dampak dan kondisi terkini" required>{{ old('deskripsi_kerusakan') }}</textarea>
                </div>
            </div>
        </div>
            ...
            <div class="form-card-body">
                <div class="form-row cols-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="latitude" id="inputLatitude" class="form-control" placeholder="-7.4500" value="{{ old('latitude') }}">
                    </div>
                    <div class="form-group">
                        <label><i class="fas fa-globe-asia" style="margin-right:0.2rem;color:#94a3b8"></i> Longitude</label>
                        <input type="text" name="longitude" id="inputLongitude" class="form-control" placeholder="112.7200" value="{{ old('longitude') }}">
                    </div>
                </div>
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div id="pelapor-fields">
                    <div class="form-row cols-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_pelapor" class="form-control" placeholder="Nama sesuai KTP" value="{{ old('nama_pelapor') }}" id="namaPelapor" required>
                        </div>
                        <div class="form-group">
                            <label><i class="fas fa-phone" style="margin-right:0.2rem;color:#94a3b8"></i> Nomor Telepon <span class="req">*</span></label>
                            <input type="tel" name="telepon" class="form-control" placeholder="08123456789" value="{{ old('telepon') }}" id="teleponPelapor" required>
                        </div>
                    </div>
                </div>
                @else
                <div style="background:#f0fdf4;border:1px solid #86efac;border-radius:10px;padding:0.65rem 1rem;margin-bottom:1rem;font-size:0.82rem;color:#15803d;">
                    <i class="fas fa-check-circle"></i> Data pelapor diisi otomatis dari akun Anda: <strong>{{ Auth::guard('web')->user()->name }}</strong>
                </div>
                <input type="hidden" name="nama_pelapor" value="{{ Auth::guard('web')->user()->name }}">
                <input type="hidden" name="telepon" value="{{ Auth::guard('web')->user()->phone ?? '-' }}">
