...
@section('title', 'Profil - SIG Irigasi Sidoarjo')
...
<section class="page-hero">
    <div class="page-hero-content">
        <div class="hero-avatar-wrap">
            <div class="hero-avatar-big">{{ substr($user->name, 0, 1) }}</div>
        </div>
        <div class="hero-text">
            <div class="badge-hero"><i class="fas fa-user-circle"></i> PROFIL SAYA</div>
            <h2>Halo, <span>{{ explode(' ', $user->name)[0] }}!</span></h2>
            <p>{{ $user->email }} &middot; Masyarakat</p>
        </div>
    </div>
</section>
    ...
    <div class="profile-grid">
        ...
        <div class="profile-left-card">
            ...
            <div class="quick-links-card">
                ...
                <a href="{{ route('peta.index') }}" class="quick-link-item">
                ...
                <a href="{{ route('laporan.index') }}" class="quick-link-item">
                ...
                <a href="{{ route('laporan.create') }}" class="quick-link-item">
                ...
                <a href="{{ route('data-irigasi.index') }}" class="quick-link-item">
        ...
        <div class="profile-right">
            ...
            <div class="profile-card">
                ...
                <div class="profile-card-body">
                    ...
                    <div id="infoView">
                        <div class="info-grid">
                            <div class="info-field">
                                ...
                                <div class="info-value"><i class="fas fa-user" style="color:var(--secondary)"></i> <span>{{ $user->name }}</span></div>
                            </div>
                            <div class="info-field">
                                <div class="info-label">Email</div>
                                <div class="info-value"><i class="fas fa-envelope" style="color:var(--secondary)"></i> <span>{{ $user->email }}</span></div>
                            </div>
                            <div class="info-field">
                                <div class="info-label">No. Telepon</div>
                                <div class="info-value"><i class="fas fa-phone" style="color:var(--secondary)"></i> <span>{{ $user->phone ?? '-' }}</span></div>
                            </div>
                            <div class="info-field">
                    ...
                    <!-- Edit mode -->
                    <div class="edit-section @if($errors->hasAny(['name','phone'])) show @endif" id="editSection">
                        <form method="POST" action="{{ route('profil.update') }}">
                            ...
                            <div class="edit-grid">
                                <div class="edit-field">
                                    ...
                                    <input type="text" name="name" class="@error('name') is-invalid @enderror" value="{{ old('name', $user->name) }}" placeholder="Nama lengkap Anda" required>
                                    @error('name')
                                ...
                                <div class="edit-field">
                                    ...
                                    <input type="tel" name="phone" class="@error('phone') is-invalid @enderror" value="{{ old('phone', $user->phone) }}" placeholder="08xx-xxxx-xxxx">
                                    @error('phone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    @if(isset($activities) && count($activities) > 0)
                        @foreach($activities as $activity)
                            <div class="activity-item">
                                <div class="activity-icon {{ $activity['icon_class'] ?? 'act-daftar' }}"><i class="fas {{ $activity['icon'] ?? 'fa-circle' }}"></i></div>
                        ...
                        <form method="POST" action="{{ route('profil.password') }}">
                            ...
                            <div class="edit-grid">
                                <div class="edit-field">
                                    ...
                                    <input type="password" name="current_password" class="@error('current_password') is-invalid @enderror" required>
